...
class RealGeneticAlgorithm:
    ...
    def select_parents(self, fitness_scores):
        if self.selection_method == "Turniejowa":
            return tournament_selection(self.population, fitness_scores, 3, optimization_goal=self.optimization_goal)
        elif self.selection_method == "Koło ruletki":
            return roulette_selection(self.population, fitness_scores, optimization_goal=self.optimization_goal)
        else:
